from schemas.provider_schema import ProviderCreate, ModelAdd
import json
import os

_BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
MODELS_JSON = os.path.join(_BASE_DIR, "data", "models", "models.json")


def _load_data() -> dict:
    """Load models.json, migrating from old format if needed."""
...
class ProviderService:
    def save_provider(self, payload: ProviderCreate) -> dict:
        data = _load_data()
        ...
        _save_data(data)
        return {"provider": payload.name, "status": "saved"}
